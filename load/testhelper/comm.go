...
func (comm *TcpComm) CheckResp(
	rawReq lib.RawReq, rawResp lib.RawResp) *lib.CallResult {
	...
	if err != nil {
		commResult.Code = lib.RESULT_FATAL_CALL
		commResult.Msg =
	...
	if err != nil {
		commResult.Code = lib.RESULT_ERROR_RESPONSE
		commResult.Msg =
	...
	if sresp.Err != nil {
		commResult.Code = lib.RESULT_ERROR_CALEE
		commResult.Msg =
	...
	commResult.Code = lib.RESULT_SUCCESS
